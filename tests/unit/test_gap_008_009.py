...
class TestTypeProjectionModel:
    ...
    def model(self):
        ...
        pytest.importorskip("torch")
        from nexus_matcher.core.type_projections import ContrastiveTypeModel, TypeProjectionConfig
...
class TestTypeProjectionManager:
    ...
    def manager(self):
        ...
        pytest.importorskip("torch")
        from nexus_matcher.core.type_projections import TypeProjectionConfig, TypeProjectionManager
    ...
    def test_project_batch(self, manager):
        ...
        types = ["string", "integer", "decimal", "datetime", "string", "boolean", "array", "object"]
