            ...
            if parsed:
                ...
                claims.append(
                    Claim(
                        ...
                        line,
                        f"Recall@{slot}",
                        (f"recall.{slot}", f"recall_at_{slot}"),
                        value,
                        tolerance,
                        text,
                        scopes,
...
def _prose_claims(
    doc: str, line_no: int, line: str, scopes: tuple[tuple[str, ...], ...]
) -> list[Claim]:
...
KNOWN_MISMATCHES: frozenset[tuple[str, str, str, str]] = frozenset(
    {
        ...
        (
            ...
            "coverage",
            "42.7%",
            "exp_calibration_combined.json curve[30].coverage=0.412791",
        ),
        (
            "CHANGELOG.md",
            "index build",
        ...
        (
            ...
            "precise",
            "86.3%",
            "exp_calibration_combined.json curve[31].precision=0.860902",
        ),
        (
            "CHANGELOG.md",
            "precise",
            "94.7%",
            "exp_calibration_combined.json curve[37].precision=0.952941",
        ),
        (
            "CHANGELOG.md",
            "value in a -> pair",
        ...
        (
            ...
            "p@1",
            "0.377",
            "exp_query_repr_combined.json variants.abbrev.p_at_1=0.376453",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "Decisions/AUTO_APPROVE",
            "421",
            "eval_pipeline_combined.json decisions.AUTO_APPROVE=85",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "Decisions/REVIEW",
            "372",
            "eval_pipeline_combined.json decisions.REVIEW=603",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "P@1",
            "0.490",
            "eval_pipeline_combined.json p_at_1=0.581395",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "P@1",
            "0.700",
            "suite_008_combined_20251209_165753.json baseline.precision_at_1=1",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "P@1",
        ...
        (
            ...
            "Recall@1",
            "0.6999",
            "eval_pipeline_combined.json recall.1=0.581395",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "Recall@10",
            "0.9193",
            "eval_pipeline_combined.json recall.10=0.877907",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "Recall@5",
            "0.8878",
            "eval_pipeline_combined.json recall.5=0.825581",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "auto-approve precision at that operating point",
            "0.9264",
            "eval_pipeline_combined.json auto_approve_precision=0.952941",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "auto-approve precision",
            "0.8559",
            "exp_calibration_combined.json curve[25].precision=0.751445",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "auto-approve precision",
            "0.9007",
            "exp_calibration_combined.json curve[29].precision=0.793548",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "auto-approve precision",
            "0.9264",
            "exp_calibration_combined.json curve[30].precision=0.852113",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "auto-approve precision",
            "0.9469",
            "exp_calibration_combined.json curve[35].precision=0.916084",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "auto-approve precision",
            "0.9586",
            "exp_calibration_combined.json curve[36].precision=0.938776",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "coverage",
            "39.6%",
            "exp_calibration_combined.json curve[36].coverage=0.142442",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "coverage",
            "42.7%",
            "exp_calibration_combined.json curve[35].coverage=0.207849",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "coverage",
        ...
        (
            ...
            "coverage",
            "54.6%",
            "exp_calibration_combined.json curve[29].coverage=0.450581",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "coverage",
            "59.5%",
            "exp_calibration_combined.json curve[25].coverage=0.502907",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "fields_per_sec",
            "652.3",
            "eval_pipeline_combined.json fields_per_sec=364.183",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "index build (793 entries)",
            "1.756",
            "eval_pipeline_combined.json index_seconds=2.06657",
        ),
        (
            ...
            "mrr@10",
            "0.5713",
            "exp_query_repr_combined.json variants.type.mrr_at_10=0.446409",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "mrr@10",
            "0.5896",
            "exp_query_repr_combined.json variants.raw.mrr_at_10=0.461424",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "mrr@10",
            "0.5963",
            "exp_query_repr_combined.json variants.underscores.mrr_at_10=0.465176",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "mrr@10",
            "0.5995",
            "exp_query_repr_combined.json variants.split.mrr_at_10=0.472121",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "mrr@10",
        ...
        (
            ...
            "mrr@10",
            "0.7530",
            "exp_query_repr_combined.json variants.full.mrr_at_10=0.647513",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "mrr@10",
            "0.7602",
            "exp_query_repr_combined.json variants.context.mrr_at_10=0.66743",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "mrr@10",
        ...
        (
            ...
            "mrr@10",
            "0.7706",
            "exp_rerank_combined.json first_stage.mrr_at_10=0.66743",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "mrr@10",
            "0.7814",
            "eval_pipeline_combined.json mrr_at_10=0.685252",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "mrr@10",
            "0.8089",
            "exp_rerank_combined.json rerankers.cross-encoder/ms-marco-MiniLM-L-6-v2.mrr_at_10=0.662994",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "n auto",
            "314",
            "exp_calibration_combined.json curve[36].n_auto=98",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "n auto",
            "339",
            "exp_calibration_combined.json curve[35].n_auto=143",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "n auto",
            "421",
            "exp_calibration_combined.json curve[30].n_auto=284",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "n auto",
            "433",
            "exp_calibration_combined.json curve[29].n_auto=310",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "n auto",
            "472",
            "exp_calibration_combined.json curve[25].n_auto=346",
        ),
        ...
        (
            ...
            "p@1",
            "0.4691",
            "exp_query_repr_combined.json variants.type.p_at_1=0.353198",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@1",
            "0.4880",
            "exp_query_repr_combined.json variants.raw.p_at_1=0.360465",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@1",
            "0.4905",
            "exp_query_repr_combined.json variants.underscores.p_at_1=0.366279",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@1",
            "0.4931",
            "exp_query_repr_combined.json variants.split.p_at_1=0.373547",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@1",
        ...
        (
            ...
            "p@1",
            "0.6671",
            "exp_query_repr_combined.json variants.full.p_at_1=0.530523",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@1",
            "0.6709",
            "exp_query_repr_combined.json variants.context.p_at_1=0.559593",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@1",
        ...
        (
            ...
            "p@1",
            "0.6910",
            "exp_rerank_combined.json first_stage.p_at_1=0.559593",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@1",
        ...
        (
            ...
            "p@1",
            "0.7465",
            "exp_rerank_combined.json rerankers.cross-encoder/ms-marco-MiniLM-L-6-v2.p_at_1=0.546512",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@5",
            "0.7087",
            "exp_query_repr_combined.json variants.type.p_at_5=0.575581",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@5",
            "0.7352",
            "exp_query_repr_combined.json variants.raw.p_at_5=0.604651",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@5",
            "0.7402",
            "exp_query_repr_combined.json variants.underscores.p_at_5=0.606105",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@5",
            "0.7427",
            "exp_query_repr_combined.json variants.split.p_at_5=0.610465",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@5",
            "0.7503",
            "exp_query_repr_combined.json variants.abbrev.p_at_5=0.630814",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@5",
            "0.8588",
            "exp_query_repr_combined.json variants.full.p_at_5=0.803779",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@5",
            "0.8726",
            "exp_query_repr_combined.json variants.context.p_at_5=0.809593",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@5",
            "0.8726",
            "exp_rerank_combined.json first_stage.p_at_5=0.809593",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@5",
            "0.8764",
            "exp_query_repr_combined.json variants.full_no_type.p_at_5=0.827035",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@5",
            "0.8878",
            "eval_pipeline_combined.json p_at_5=0.825581",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "p@5",
            "0.8916",
            "exp_rerank_combined.json rerankers.cross-encoder/ms-marco-MiniLM-L-6-v2.p_at_5=0.824128",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "queries_per_sec",
            "18.1",
            "exp_rerank_combined.json rerankers.cross-encoder/ms-marco-MiniLM-L-6-v2.queries_per_sec=87.327",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "r@50",
            "0.8953",
            "exp_query_repr_combined.json variants.type.recall.50=0.80814",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "r@50",
            "0.9016",
            "exp_query_repr_combined.json variants.raw.recall.50=0.837209",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "r@50",
            "0.9029",
            "exp_query_repr_combined.json variants.abbrev.recall.50=0.859012",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "r@50",
            "0.9029",
            "exp_query_repr_combined.json variants.underscores.recall.50=0.838663",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "r@50",
            "0.9042",
            "exp_query_repr_combined.json variants.split.recall.50=0.837209",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "r@50",
            "0.9533",
            "exp_query_repr_combined.json variants.full.recall.50=0.938953",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "r@50",
            "0.9596",
            "exp_query_repr_combined.json variants.context.recall.50=0.949128",
        ),
        (
            "docs/BENCHMARK_REGISTRY.md",
            "r@50",
            "0.9609",
            "exp_query_repr_combined.json variants.full_no_type.recall.50=0.952035",
        ),
        (
            "docs/ENHANCEMENT_JOURNEY.md",
            "coverage",
            "39.6%",
            "exp_calibration_combined.json curve[36].coverage=0.142442",
        ),
        ...
        (
            ...
            "auto-approve precision at default threshold",
            "0.947",
            "eval_pipeline_combined.json auto_approve_precision=0.952941",
        ),
        (
            "docs/PROJECT_STATE.md",
            "end-to-end p@1 (793-pair labelled benchmark)",
            "0.700",
            "eval_pipeline_combined.json p_at_1=0.581395",
        ),
        (
        ...
        (
            "docs/PROJECT_STATE.md",
            "p@1 on the abbreviation-heavy split (bird)",
            "0.490",
            "eval_pipeline_combined.json p_at_1=0.581395",
        ),
        (
            "docs/PROJECT_STATE.md",
            "p@1 on the descriptive split (omop)",
            "0.819",
            "eval_pipeline_combined.json p_at_1=0.581395",
        ),
        (
        ...
        (
            "docs/modules/abbreviation_expansion.md",
            "P@1",
            "0.309",
            "exp_query_repr_combined.json variants.type.p_at_1=0.353198",
        ),
        ...
        (
            "docs/modules/context_enricher.md",
            "p@1",
            "0.469",
            "exp_query_repr_combined.json variants.type.p_at_1=0.353198",
        ),
        ...
        (
            ...
            "value in a -> pair",
            "0.691",
            "exp_query_repr_combined.json variants.split.recall.10=0.678779",
        ),
        (
            "docs/modules/cross_encoder_reranker.md",
            "MRR@10",
            "0.771",
            "exp_rerank_combined.json first_stage.mrr_at_10=0.66743",
        ),
